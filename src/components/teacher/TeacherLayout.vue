        ...
        <div class="flex flex-col flex-grow pt-5 bg-white overflow-y-auto">
          ...
          <div class="mt-5 flex-grow flex flex-col">
            <nav class="flex-1 px-2 pb-4 space-y-1">
              ...
              >
                <BookOpen class="mr-3 h-5 w-5 text-gray-400" />
                <span class="truncate">Texts</span>
              </router-link>

              <!-- New Analysis Navigation Link -->
              <router-link
                :to="{ name: 'teacher-analysis' }"
                class="group flex items-center px-2 py-2 text-sm font-medium rounded-md"
                :class="[
                  isAnalysisRoute
                    ? 'bg-gray-100 text-gray-900'
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
              ...
              <div v-if="pageTitle" class="mb-6">
                <div class="flex justify-between items-center">
                  ...
                  <router-link
                    v-if="currentRoute === 'teacher-texts-list'"
                    :to="{ name: 'create-text' }"
...
const isTextRoute = computed(() => {
  return ['teacher-texts-list', 'create-text', 'view-text', 'edit-text'].includes(currentRoute.value)
})

// Check if current route is analysis-related
const isAnalysisRoute = computed(() => {
  return ['teacher-analysis', 'single-report', 'cumulative-report'].includes(currentRoute.value)
})
